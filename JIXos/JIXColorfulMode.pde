...
void colorfulGenericDisplay(uint8_t ledStartNumber, uint8_t value, uint8_t pieceNumber, const bool ** pieces, uint8_t piecesSize, uint8_t luminosity, uint8_t color)
{  
